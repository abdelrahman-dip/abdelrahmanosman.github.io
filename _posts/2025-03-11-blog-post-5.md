...
## Mixer Design procedure

A single balanced mixer (DBM) provides excellent port isolation, suppression of even-order harmonics, and balanced operation by using four diodes in a ring configuration, but here it's implemented with 2 diodes and microstrip lines for simplicity, likely in a balanced single-diode pair topology with baluns or transformers implied in the microstrip structure.
