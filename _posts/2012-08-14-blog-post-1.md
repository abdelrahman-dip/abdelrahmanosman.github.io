...
The goal is to design a **Low Noise Amplifier (LNA)** operating from \\( \SI{1.4}{\giga\hertz} \\) to \\( \SI{1.8}\text{GHz}} \\), using Advanced Design System (ADS). The design specifications are as follows:
